const contractAddress = "0xD4e484573FAd3113423b39710Fe349D5c4422C62"; // Replace with your own contract address
const chain = 'rinkeby'; // rinkeby, polygon, or ethereum

const welcome_h1 = "Welcome to the drgbv NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The drgbv NFT Project is a decentralized, open-source project that aims to demonstrate how to develope and launch your own NFT Collection.';
// Follow step by step on the <a href="https://youtube.com/codestackr"  target="_blank" rel="noopener noreferrer">codeSTACKr</a> YouTube channel.';
